...
export default function Features() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        Smart Features to Power Up Your <br/><span className="tracking-tighter text-balance text-transparent from-primary/10 via-foreground/85 to-foreground/50 bg-gradient-to-tl bg-clip-text">Contract Management</span>
        </h2>
