  ...
  const templates: Template[] = [
    {
      ...
      long:
        "A concise, structured document ideal for status updates, research summaries, and analytical write-ups. Includes headings for overview, findings, and recommendations.",
    },
    {
      id: "article",
      name: "Article",
      ...
      long:
        "A reader-friendly narrative format suitable for blogs, knowledge base entries, and editorial content. Emphasizes clarity, subheadings, and scannability.",
    },
    {
      id: "presentation",
      name: "Presentation",
      ...
      long:
        "Slide-oriented outline designed for decks and talks. Focuses on bullet points, key takeaways, and visual pacing across sections.",
    },
    {
      id: "technical",
      name: "Technical Spec",
      ...
      long:
        "A detailed specification template for technical documentation, including context, requirements, API shapes, edge cases, and acceptance criteria.",
    },
  ];
    ...
    <div className="space-y-6">
      ...
      <section className="flex flex-col space-y-6">
        <h2 className="text-xl font-light">
          Start by uploading your document, giving it a name and a description
        </h2>
          ...
          <section className="flex flex-col space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="md:col-span-1 space-y-3">
                {templates.map((t) => (
                  ...
                  >
                    <Card
                      className={
                        "cursor-pointer transition-colors rounded-2xl border-border hover:bg-accent/30" +
                        (selectedId === t.id
              ...
              <div className="md:col-span-2">
                <Card className="min-h-[16rem] rounded-2xl">
                      ...
                      >
                        <CardHeader className="flex flex-row items-center gap-3">
                          ...
                          <div>
                            ...
                            <CardDescription>{selected.short}</CardDescription>
                          </div>
                        </CardHeader>
                        <Separator/>
